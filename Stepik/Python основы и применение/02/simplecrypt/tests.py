...
class TestEncryption(TestCase):
    ...
    def test_unicode_plaintext(self):
        ...
        ptext = decrypt('password',
                        encrypt('password', u_message.encode('utf8')))
        ...
        ptext = decrypt('password',
                        encrypt('password', u_high_order.encode('utf8')))
...
class TestRandBytes(TestCase):
    ...
    def test_all_values(self):
        ...
        b = _random_bytes(255)
        assert not reduce(lambda a, b: a and b,
                          (n in b for n in range(256)), True)
